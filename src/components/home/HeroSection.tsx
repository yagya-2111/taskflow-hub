  ...
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden" style={{ background: 'var(--gradient-hero)' }}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-[15%] animate-float hidden md:block" style={{ animationDelay: '1s' }}>
        ...
        <div className="absolute top-1/3 right-[15%] animate-float hidden md:block" style={{ animationDelay: '2s' }}>
        ...
        <div className="absolute bottom-1/3 left-[20%] animate-float hidden md:block" style={{ animationDelay: '4s' }}>
          <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center backdrop-blur-sm border border-primary/20">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-3xl mx-auto text-center">
          <div className="animate-fade-in-up mb-6">
            <img src={logo} alt="TaskEarn" className="h-16 md:h-20 lg:h-28 w-auto mx-auto drop-shadow-2xl" />
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card-dark mb-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <span className="text-xs md:text-sm text-muted-foreground">Trusted by 15,000+ earners across India</span>
          </div>

          <h1 className="text-3xl md:text-5xl lg:text-7xl font-extrabold leading-tight mb-6 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            <span style={{ color: 'hsl(220 15% 90%)' }}>Invest ₹500, Earn</span><br />
            <span className="text-gradient-primary">₹700 Guaranteed!</span>
          </h1>

          <p className="text-base md:text-lg lg:text-xl mb-8 md:mb-10 max-w-xl mx-auto animate-fade-in-up px-4" style={{ animationDelay: '0.2s', color: 'hsl(220 10% 55%)' }}>
            Complete 5 simple tasks, earn ₹40 per task. Your ₹500 deposit + ₹200 earnings = ₹700 withdrawable. Instant UPI withdrawal.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center animate-fade-in-up px-4" style={{ animationDelay: '0.3s' }}>
            <Button
              size="lg"
              className="gradient-primary text-primary-foreground glow-primary text-base md:text-lg px-6 md:px-8 py-5 md:py-6 rounded-xl group"
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-base md:text-lg px-6 md:px-8 py-5 md:py-6 rounded-xl border-border/30 hover:border-primary/30 hover:bg-primary/5 transition-all"
          ...
          {/* Mini stats */}
          <div className="grid grid-cols-3 gap-3 md:gap-4 mt-12 md:mt-16 max-w-lg mx-auto animate-fade-in-up px-4" style={{ animationDelay: '0.4s' }}>
            {[
              ...
              <div key={s.label} className="text-center">
                <p className="text-xl md:text-2xl lg:text-3xl font-extrabold text-gradient-primary">{s.value}</p>
